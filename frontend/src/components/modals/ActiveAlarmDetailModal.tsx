...
const ActiveAlarmDetailModal: React.FC<ActiveAlarmDetailModalProps> = ({ alarm, onClose, onAcknowledge, onClear }) => {
    ...
    const getStatusText = (s: string) => {
        switch (s) {
            case 'active': return t('state.pending', { defaultValue: '대기 중 (활성)' });
            case 'acknowledged': return t('state.acknowledged', { defaultValue: '인지됨' });
            case 'cleared': return t('state.cleared', { defaultValue: '해제됨' });
            default: return s;
        }
    };
        ...
        <div className="modal-overlay">
            <div className="modal modal-xl">
                <div className="modal-header">
                    <h2 className="modal-title">{t('modals.activeDetailTitle', { defaultValue: '활성 알람 상세' })}: #{alarm.id}</h2>
                            ...
                            <div className="form-section">
                                ...
                                <div className="detail-item-group" style={{ marginBottom: '20px' }}>
                                    ...
                                    <div className="detail-read-value" style={{
                                        ...
                                        {alarm.message || t('modals.noMessage', { defaultValue: '메시지 없음' })}
                                    </div>
                                </div>
                                <div className="detail-item-group" style={{ marginBottom: '20px' }}>
                                            ...
                                            <div className="timeline-content">
                                                ...
                                                <div style={{ marginTop: '4px', fontSize: '13px' }}>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                                        ...
                                                        <span style={{ fontWeight: 500 }}>{alarm.acknowledged_by_name || alarm.acknowledged_by || t('modals.unknownUser', { defaultValue: '알 수 없음' })}</span>
                                                    </div>
                                            ...
                                            <div className="timeline-content">
                                                ...
                                                <div style={{ marginTop: '4px', fontSize: '13px' }}>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                                        ...
                                                        <span style={{ fontWeight: 500 }}>{alarm.cleared_by_name || alarm.cleared_by || t('modals.unknownUser', { defaultValue: '알 수 없음' })}</span>
                                                    </div>
                                                    {alarm.comment && alarm.state === 'cleared' && (
