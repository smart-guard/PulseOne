...
const ProtocolDetailModal: React.FC<ProtocolDetailModalProps> = ({
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-container protocol-modal">
        {/* 모달 헤더 */}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div className="title-row">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '4px' }}>
                  ...
                  <span className={`badge ${protocol.category ? 'primary' : 'neutral'}`}>
        ...
        <div className="modal-body">
          <div className="modal-form-grid">
            ...
            <div className="modal-form-section">
              ...
              <div className="modal-form-row">
                <div className="detail-item">
                  <div className="detail-label">프로토콜 타입</div>
                  <div className="detail-value">{protocol.protocol_type}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-label">표시명</div>
                  <div className="detail-value highlight">{protocol.display_name}</div>
                </div>
                {protocol.is_deprecated && (
                  <div className="detail-item" style={{ marginLeft: 'auto', marginBottom: 'auto' }}>
                    <span className="status-pill warning" style={{ fontSize: '11px', padding: '2px 8px' }}>사용 중단 예정</span>
                  </div>
                )}
              </div>
              ...
              <div className="detail-item">
                ...
                <div className="detail-value">{protocol.description || '설명이 없습니다.'}</div>
              </div>

              <div className="modal-form-row" style={{ gridTemplateColumns: '1fr 1fr 1fr' }}>
                <div className="detail-item">
                  <div className="detail-label">카테고리</div>
                  <div className="detail-value">{protocol.category || 'network'}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-label">기본 포트</div>
                  <div className="detail-value">{protocol.default_port || '-'}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-label">제조사/벤더</div>
                  <div className="detail-value">{protocol.vendor || '-'}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-label">최소 펌웨어</div>
                  <div className="detail-value">{protocol.min_firmware_version || '-'}</div>
                </div>
              </div>
            </div>
            ...
            <div className="modal-form-section">
              ...
              <div className="modal-form-row" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
                <div className="detail-item">
                  <div className="detail-label">기본 폴링 (ms)</div>
                  <div className="detail-value">{protocol.default_polling_interval || '-'}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-label">기본 타임아웃 (ms)</div>
                  <div className="detail-value">{protocol.default_timeout || '-'}</div>
                </div>
                <div className="detail-item">
                  <div className="detail-label">최대 동시 연결</div>
                  <div className="detail-value">{protocol.max_concurrent_connections || '-'}</div>
                </div>
              </div>

              <div className="modal-form-row" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
                <div className="detail-item">
                  <div className="detail-label">시리얼 사용</div>
                ...
                <div className="detail-item">
                  <div className="detail-label">브로커 필요</div>
                  <div className="detail-value">
                ...
                <div className="detail-item">
                  ...
                  <div className="detail-value">
                    <span className={`status-pill ${protocol.is_enabled ? 'active' : 'inactive'}`}>
                      {protocol.is_enabled ? '활성' : '비활성'}
                    </span>
                  </div>
                </div>
            ...
            <div className="modal-form-domains">
              ...
              <div className="modal-form-domain">
                <div className="modal-form-section">
                  ...
                  <div className="detail-item">
                    <div className="detail-label">지원 명령어 (Operations)</div>
                  ...
                  <div className="detail-item" style={{ marginBottom: 0 }}>
                    <div className="detail-label">지원 데이터 타입 (Data Types)</div>
                    <div className="capability-badge-container">
              ...
              <div className="modal-form-domain">
                <div className="modal-form-section">
                  ...
                  <div className="detail-item" style={{ marginBottom: 0 }}>
                    <div className="detail-value text-sm" style={{
            ...
            <div className="modal-form-section span-full">
              ...
              <div style={{ display: 'flex', justifyContent: 'space-around', textAlign: 'center' }}>
                <div className="detail-item" style={{ marginBottom: 0 }}>
                  <div className="detail-label">총 디바이스</div>
                  <div className="detail-value highlight" style={{ fontSize: '24px' }}>{protocol.device_count || 0}</div>
                </div>
                <div className="detail-item" style={{ marginBottom: 0 }}>
                  <div className="detail-label">활성 디바이스</div>
                  <div className="detail-value highlight" style={{ fontSize: '24px', color: 'var(--success-600)' }}>
                    {protocol.enabled_count || 0}
                  </div>
                </div>
                <div className="detail-item" style={{ marginBottom: 0 }}>
                  <div className="detail-label">연결됨</div>
                  <div className="detail-value highlight" style={{ fontSize: '24px', color: 'var(--primary-600)' }}>
