...
const FILES = [
    ...
    '/app/src/components/VirtualPoints/VirtualPointModal/InputVariableEditor.tsx',
    '/app/src/components/VirtualPoints/VirtualPointTable.tsx',
...
for (const fp of FILES) {
    ...
    if (found.length > 0) {
        ...
        found.slice(0, 6).forEach(l => console.log(l));
        if (found.length > 6) console.log('  ... +' + (found.length - 6));
    }
}
