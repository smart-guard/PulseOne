...
private:
    ...
    std::vector<std::string> pending_monitored_items_; // NodeIDs waiting to be monitored
    ...
    void BrowseRecursive(UA_NodeId nodeId, std::vector<PulseOne::Structs::DataPoint>& points, int depth = 0);
