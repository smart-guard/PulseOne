...
public:
   ...
   */
  void RecordConnectionEvent(bool connected, const std::string &broker_url,
   ...
   */
  void RecordPublish(const std::string &topic, size_t payload_size, int qos,
   ...
   * @param reason 손실 원인
   */
  void RecordMessageLoss(const std::string &topic, int qos,
   ...
   */
  void RecordOperation(const std::string &operation, bool success,
                       double duration_ms);
