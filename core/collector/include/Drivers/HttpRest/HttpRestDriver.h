...
private:
    ...
    void SetError(const std::string& message, Structs::ErrorCode code = Structs::ErrorCode::DEVICE_ERROR);
    void UpdateStatistics(const std::string& operation, bool success, double duration_ms = 0.0);
