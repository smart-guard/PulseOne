...
public:
    ...
    bool WriteDataPoint(const std::string& point_id, const PulseOne::Structs::DataValue& value) override;
...
private:
    std::unique_ptr<PulseOne::Drivers::OPCUADriver> opcua_driver_;
