...
public:
  ...
  json toJson() const override {
    ...
    try {
      ...
      if (protocol_instance_id_.has_value()) {
        j["protocol_instance_id"] = protocol_instance_id_.value();
      }
      // 디바이스 정보
      j["name"] = name_;
  ...
  bool fromJson(const json &data) override {
    try {
      ...
      if (data.contains("protocol_instance_id")) {
        setProtocolInstanceId(data["protocol_instance_id"].get<int>());
      }
  ...
  std::string toString() const override {
    ...
    oss << ", protocol_instance_id="
        << (protocol_instance_id_.has_value()
                ? std::to_string(protocol_instance_id_.value())
                : "null");
  ...
  std::optional<int> getProtocolInstanceId() const {
    return protocol_instance_id_;
  }
  void setProtocolInstanceId(const std::optional<int> &protocol_instance_id) {
    protocol_instance_id_ = protocol_instance_id;
    markModified();
  }
  void setProtocolInstanceId(int protocol_instance_id) {
    protocol_instance_id_ = protocol_instance_id;
    markModified();
  }
  ...
  getInstallationDate() const {
    return installation_date_;
  }
  void
  setInstallationDate(const std::optional<std::chrono::system_clock::time_point>
                          &installation_date) {
    installation_date_ = installation_date;
    markModified();
  }
  void setInstallationDate(
      const std::chrono::system_clock::time_point &installation_date) {
    installation_date_ = installation_date;
    markModified();
  }

  std::optional<std::chrono::system_clock::time_point>
  getLastMaintenance() const {
    return last_maintenance_;
  }
  void
  setLastMaintenance(const std::optional<std::chrono::system_clock::time_point>
                         &last_maintenance) {
    last_maintenance_ = last_maintenance;
    markModified();
  }
  void setLastMaintenance(
      const std::chrono::system_clock::time_point &last_maintenance) {
    last_maintenance_ = last_maintenance;
    markModified();
  }
  ...
  std::string
  dateToString(const std::chrono::system_clock::time_point &date) const;
...
private:
  ...
  std::optional<int> protocol_instance_id_;
