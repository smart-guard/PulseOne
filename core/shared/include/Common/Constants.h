...
namespace Constants {
    ...
    constexpr int DEFAULT_MODBUS_MAX_REGISTERS = 125;            // 한번에 읽을 수 있는 최대 레지스터
    ...
    constexpr int MAX_MQTT_PAYLOAD_SIZE = 268435455;             // MQTT 최대 페이로드 (256MB - 1)
    ...
    constexpr double MEMORY_USAGE_WARNING_THRESHOLD = 85.0;     // 메모리 사용률 85% 경고
    ...
    // 🆕 점검 모드 보안
    constexpr int MAINTENANCE_ACCESS_TIMEOUT_MINUTES = 60;      // 1시간 점검 접근 타임아웃
    ...
    constexpr std::string_view DEFAULT_PLUGINS_DIR = "./plugins";
    constexpr std::string_view DEFAULT_MAINTENANCE_LOG_FILE = "maintenance.log";  // 🆕
    ...
    constexpr int NETWORK_KEEPALIVE_TIMEOUT_S = 300;            // 5분 킵얼라이브
