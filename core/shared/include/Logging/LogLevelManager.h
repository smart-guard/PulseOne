// =============================================================================
// collector/include/Logging/LogLevelManager.h - 경고 없는 자동 초기화 버전
...
public:
     ...
     * @brief 수동 초기화 (기존 호환성)
     */
    void Initialize(ConfigManager* config = nullptr, DbLib::DatabaseManager* db = nullptr) {
        config_ = config;
        db_manager_ = db;
        // ...
    }
...
private:
    ...
    bool doInitialize();
    bool doInitialize(ConfigManager* config, DbLib::DatabaseManager* db);
