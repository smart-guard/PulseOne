...
public:
     ...
     * @return 업로드 결과
     */
    S3UploadResult upload(const std::string& object_key,
     ...
     * @return 업로드 결과
     */
    S3UploadResult uploadJson(const std::string& object_key,
     ...
     * @return 객체 목록
     */
    std::vector<S3Object> listObjects(const std::string& prefix = "", int max_keys = 1000);
     ...
     * @return 생성된 파일명
     */
    std::string generateTimestampFileName(const std::string& prefix = "file",
...
private:
     ...
     */
    std::string createSignatureV4(const std::string& method,
     ...
     */
    std::string createCanonicalRequest(const std::string& method,
                                      const std::string& uri,
                                      const std::unordered_map<std::string, std::string>& query_params,
                                      const std::unordered_map<std::string, std::string>& headers,
                                      const std::string& payload);
     ...
     */
    std::string createStringToSign(const std::string& canonical_request,
                                  const std::chrono::system_clock::time_point& timestamp);
     ...
     * @return Signing Key
     */
    std::string createSigningKey(const std::chrono::system_clock::time_point& timestamp);
     ...
     * @return 인코딩된 문자열
     */
    std::string urlEncode(const std::string& str, bool encode_slash = false) const;
     ...
     * @return 업로드 결과
     */
    S3UploadResult executeUploadWithRetry(const std::string& object_key,
                                         const std::string& content,
                                         const std::string& content_type,
                                         const std::unordered_map<std::string, std::string>& metadata);
