...
public:
    ...
    std::string getOrDefault(const std::string& key, const std::string& defaultValue) const override;
     ...
     * @return 성공 여부
     */
    bool setSecret(const std::string& config_key, const std::string& value, bool encrypt = true);
     ...
     * @brief AWS 자격증명 설정
     */
    bool setAWSCredentials(const std::string& access_key, const std::string& secret_key);
     ...
     */
    bool setDatabasePassword(const std::string& db_type, const std::string& password);
...
private:
     ...
     */
    std::map<std::string, std::string> parseConfigFile(const std::string& filepath) const;
...
inline bool SetConfigBool(const std::string& key, bool value) {
    return ConfigManager::getInstance().updateConfig(key, value ? "true" : "false");
}
...
inline bool SetSecret(const std::string& config_key, const std::string& value, bool encrypt = true) {
...
inline bool SetAWSCredentials(const std::string& access_key, const std::string& secret_key) {
