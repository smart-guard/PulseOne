...
void LoggerEngine::log(const std::string& category, LogLevel level, const std::string& message) {
...
void LoggerEngine::logPacket(const std::string& driver, const std::string& device,
...
void LoggerEngine::applyConfig(const std::string& key, const std::string& value) {
    if (key == "LOG_LEVEL") {
...
LogLevel LoggerEngine::stringToLogLevel(const std::string& level) {
    ...
    if (s == "MAINTENANCE") return LogLevel::MAINTENANCE;
...
std::filesystem::path LoggerEngine::buildLogDirectoryPath(const std::string& category) {
...
std::filesystem::path LoggerEngine::buildLogFilePath(const std::string& category) {
...
void LoggerEngine::checkAndRotateLogFile(const std::string& filePath, std::ofstream& stream) {
...
void LoggerEngine::updateStatistics(LogLevel level) {
    ...
    switch (level) {
        ...
        case LogLevel::WARN: statistics_.warn_count++; break;
