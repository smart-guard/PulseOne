...
public:
    ...
    std::vector<ExportResult> handleAlarmBatch(const std::vector<PulseOne::CSP::AlarmMessage>& alarms);
    ...
    void logExportResult(const ExportResult& result, const PulseOne::CSP::AlarmMessage* alarm_message = nullptr);
...
private:
    ...
    ExportResult convertTargetSendResult(const PulseOne::CSP::TargetSendResult& target_result) const;
