...
public:
    ...
    std::optional<PulseOne::Database::Entities::ExportScheduleEntity> getSchedule(int schedule_id) const;
...
private:
    ...
    std::vector<PulseOne::Database::Entities::ExportScheduleEntity> findDueSchedules();
    ...
    std::unique_ptr<PulseOne::Database::Repositories::PayloadTemplateRepository> template_repo_;
    
    std::unique_ptr<std::thread> worker_thread_;
    std::atomic<bool> is_running_{false};
    std::atomic<bool> should_stop_{false};
    
    std::map<int, PulseOne::Database::Entities::ExportScheduleEntity> cached_schedules_;
