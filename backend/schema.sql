...
CREATE TABLE IF NOT EXISTS edge_servers (
    ...
    is_deleted INTEGER DEFAULT 0,                          -- bool is_deleted
    last_seen DATETIME,
...
CREATE TABLE IF NOT EXISTS users (
    ...
    -- 🔥 계정 상태
    is_active INTEGER DEFAULT 1,
    is_deleted INTEGER DEFAULT 0,                         -- Added for soft delete logic
...
CREATE INDEX IF NOT EXISTS idx_devices_template ON devices(template_device_id);
