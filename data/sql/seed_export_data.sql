...
VALUES (1, 'Demo Export Profile', 'Auto-generated for testing', '[]', 1, datetime('now', 'localtime'), datetime('now', 'localtime'));
...
VALUES (1, 1, 'Local MQTT Broker', 'mqtt', '{"host":"localhost","port":1883,"topic":"data/export"}', 'realtime', 10, 100, 1, datetime('now', 'localtime'), datetime('now', 'localtime'));
...
VALUES (1, 1, 1, 'temp_sensor_01', 'Primary Temperature', '{"factor":1}', 1, datetime('now', 'localtime'));
...
VALUES (1, 6, 1, datetime('now', 'localtime'));
