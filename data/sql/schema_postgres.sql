...
CREATE TABLE IF NOT EXISTS current_values (
    ...
    -- 🔥 타임스탬프들
    value_timestamp TIMESTAMP,                          -- 값 변경 시간
    quality_timestamp TIMESTAMP,                        -- 품질 변경 시간  
    last_log_time TIMESTAMP,                            -- 마지막 로깅 시간
    last_read_time TIMESTAMP,                           -- 마지막 읽기 시간
    last_write_time TIMESTAMP,                          -- 마지막 쓰기 시간
...
CREATE TABLE IF NOT EXISTS data_history (
    ...
    -- 🔥 시간 정보
    timestamp TIMESTAMP NOT NULL,                     -- 값 타임스탬프
    source_timestamp TIMESTAMP,                       -- 소스 타임스탬프
...
CREATE TABLE IF NOT EXISTS virtual_point_history (
    ...
    calculation_timestamp TIMESTAMP,                  -- 계산 시작 시간
