-- =============================================================================
-- PulseOne PostgreSQL Schema (Generated from schema.sql - 2026-03-06)
-- 주의: schema.sql에서 자동 변환됨. 최종 배포 전 검톰 필요.
-- =============================================================================
...
CREATE TABLE template_devices (
    ...
    created_by INTEGER,
    created_at DATETIME DEFAULT NOW(),
    updated_at DATETIME DEFAULT NOW(), is_deleted TINYINT DEFAULT 0,
...
CREATE TABLE backups (id SERIAL PRIMARY KEY, name TEXT NOT NULL, filename TEXT NOT NULL UNIQUE, type TEXT DEFAULT 'full', status TEXT DEFAULT 'completed', size INTEGER DEFAULT 0, location TEXT DEFAULT '/app/data/backup', created_at TIMESTAMP DEFAULT NOW(), created_by TEXT, description TEXT, duration INTEGER, is_deleted INTEGER DEFAULT 0);
-- =============================================================================
