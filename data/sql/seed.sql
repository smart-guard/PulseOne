...
-- Table: export_targets
INSERT INTO export_targets (id, tenant_id, name, target_type, is_enabled, config, export_mode, export_interval, batch_size, execution_delay_ms, created_at, updated_at) VALUES(18,3,'insite API Gateway(stg)','HTTP',1,'[{"url":"https://rhnkxbwgb9.execute-api.ap-northeast-2.amazonaws.com/icos5Api/alarm","method":"POST","headers":{"Content-Type":"application/json","x-api-key":"${INSITE_API_GATEWAY_STG_APIKEY_4732}","Authorization":"${INSITE_API_GATEWAY_STG_AUTH_5850}"},"timeout":10000,"retry":3,"retryDelay":2000,"execution_order":3}]','on_change',0,100,0,'2026-02-06 04:03:25','2026-02-06 04:07:55');
INSERT INTO export_targets (id, tenant_id, name, target_type, is_enabled, config, export_mode, export_interval, batch_size, execution_delay_ms, created_at, updated_at) VALUES(19,3,'insite S3(stg)','S3',1,'[{"bucket_name":"hdcl-csp-stg","AccessKeyID":"${INSITE_S3_STG_S3_ACCESS_8503}","SecretAccessKey":"${INSITE_S3_STG_S3_SECRET_3105}","S3ServiceUrl":"https://rhnkxbwgb9.execute-api.ap-northeast-2.amazonaws.com/icos5Api/alarm","region":"ap-northeast-2","Folder":"e2e-s3","execution_order":1}]','on_change',0,100,0,'2026-02-06 04:03:32','2026-02-06 04:07:55');
-- Table: export_profile_assignments
